//
//  GMSWideReceiverDraftViewController.m
//  AutoDraft
//
...
#import "GMSWideReceiverDraftViewController.h"

@implementation GMSWideReceiverDraftViewController

- (void) viewWillAppear:(BOOL)animated
{
    self.arrayToUse = [[GMSDraftManager sharedInstance] wideReceivers];
