//
//  GMSTightEndDraftViewController.m
//  AutoDraft
//
...
#import "GMSTightEndDraftViewController.h"

@implementation GMSTightEndDraftViewController

- (void) viewWillAppear:(BOOL)animated
{
    self.arrayToUse = [[GMSDraftManager sharedInstance] tightEnds];
